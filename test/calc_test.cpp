...
TEST(calc_test, basic_operands_not_truncated){
    static_assert(approx_equal(*calc::evaluate<double>("(1 + 2) * (3 + 4) / 5"), 4.2));
    static_assert(approx_equal(*calc::evaluate<double>("((8 - 3) * (2 + 1)) + (4 / 2)"), 17.0));
    static_assert(approx_equal(*calc::evaluate<double>("(18 + (12 / 3)) * (2 - 1)"), 22.0));
    static_assert(approx_equal(*calc::evaluate<double>("((6 * 3) - (4 + 2)) / 2"), 6.0));
    static_assert(approx_equal(*calc::evaluate<double>("-((10 - 3) * (2 + 2)) + 5"), -23.0));
    static_assert(approx_equal(*calc::evaluate<double>("((5 + 5) * (3 - 1) + 6) / 4"), 6.5));
    static_assert(approx_equal(*calc::evaluate<double>("(20 / (2 + 3)) + (6 * 2)"), 16.0));
    static_assert(approx_equal(*calc::evaluate<double>("(((9 + 3) / 3) * 2) - 1"), 7.0));
    static_assert(approx_equal(*calc::evaluate<double>("((15 - 5) / (2 + 3)) + (1 * 4)"), 6.0));
    static_assert(approx_equal(*calc::evaluate<double>("(((((2 + 2) * 2) + 4) / 2) - 1) * 3"), 15.0));
}
